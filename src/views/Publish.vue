...
export default {
  ...
  methods: {
    ...
    handlePictureCardPreview(file) {
      ...
      console.log("照片路径", this.dialogImageUrl);
    ...
    fileHandleSuccess(response, file, fileList) {
      ...
      console.log(this.formLabelAlign.pictureList);
      // this.formLabelAlign.pictureList.unshift(response.data);
    },
    //发布按钮
    release() {
      console.log("被调用了");
      console.log(this.formLabelAlign);
      this.formLabelAlign.pictureList=JSON.stringify(this.imgList);
